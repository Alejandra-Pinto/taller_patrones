...
public class EstadoInicio implements IEstadoProyecto {

    @Override
    public void avanzar(ProjectState proyecto) {
        System.out.println("Formato A diligenciado, esperando evaluacion.");
    ...
    public String getNombreEstado() {
        return "Formato A diligenciado, esperando evaluacion.";
    }
}
